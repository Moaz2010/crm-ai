  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-black/10 dark:border-slate-700 px-8 py-6 md:w-[450px] bg-black/5 dark:bg-slate-900"
            key={item.name}
          >
            <blockquote>
              <div
