...
export default function CalendarSync() {
  return (
    <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
      <h3 className="text-lg font-bold text-white mb-4">Connected Calendars</h3>
      <div className="space-y-4">
        <div className="flex items-center justify-between p-3 rounded-xl bg-black/20 border border-white/5">
          ...
          <div className="flex items-center gap-2 text-green-400 text-xs font-medium bg-green-400/10 px-2 py-1 rounded-lg">
            <Check className="h-3 w-3" />
            Synced
          </div>
        </div>

        <div className="flex items-center justify-between p-3 rounded-xl bg-black/20 border border-white/5 opacity-75 hover:opacity-100 transition-opacity cursor-pointer group">
          <div className="flex items-center gap-3">
